  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        безопасности персональных данных, предпринимаемые ООО "Барс Профи"
        (далее — Оператор).
        <br />
        ...
        Оператор может получить о посетителях веб-сайта https://barsprofi.ru.
        <br />
        ...
        сети интернет по сетевому адресу https://barsprofi.ru.
        <br />
        ...
        распространения).
        <br />
        2.10. Пользователь — любой посетитель веб-сайта https://barsprofi.ru.
        <br />
        ...
        <br />— отвечать на обращения и запросы субъектов персональных данных и
        ...
        <br />— публиковать или иным образом обеспечивать неограниченный доступ
        ...
        <ul>
          <li>
            Цель обработкиУточнение деталей заказаПерсональные данныефамилия,
            имя, отчество
          </li>
          ...
          <li>
            Виды обработки персональных данныхСбор, запись, систематизация,
        ...
        уведомление на адрес электронной почты Оператора galiev09.99@gmail.com с
        ...
        электронной почты на электронный адрес Оператора galiev09.99@gmail.com с
        ...
        Оператору с помощью электронной почты galiev09.99@gmail.com.
        <br />
        ...
        Интернет по адресу https://barsprofi.ru/privacypolicy.
      </div>
    </div>
  );
}
